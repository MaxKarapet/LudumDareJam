...
@export var radius:=30.0 : set = set_crosshair_radius
@export var thickness:=1.0 : set = set_crosshair_thickness
@export var color:=Color.WHITE : set =  set_crosshair_color
@export var gap_angle:=45.0 : set = set_crosshair_gap_angle
@export var segments:=32 : set = set_crosshair_segments
